...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-identity-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10413&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-identity-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-identity` can be installed with:

```
conda install azure-identity
```

It is possible to list all of the versions of `azure-identity` available on your platform with:
